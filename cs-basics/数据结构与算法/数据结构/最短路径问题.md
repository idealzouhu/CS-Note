...
### 2.1 Dijkstra 算法
 ...
 Dijkstra（迪杰斯特拉） 算法是一种用于计算图中从一个源点到所有其他顶点的最短路径的贪心算法。该算法通过<font color="blue">**逐步扩展最短路径集合来求解**</font>，每次选择距离源点最近的尚未访问顶点加入最短路径集合，然后更新与该顶点相邻的尚未访问顶点的距离值。
...
[弗洛伊德算法_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1Xd4y1X73b/?spm_id_from=333.337.search-card.all.click&vd_source=52cd9a9deff2e511c87ff028e3bb01d2)